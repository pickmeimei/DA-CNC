...
###和扩散表示进行对比（1.原图和扩散图相当于两个视图，从这两个视图中学习到的表示之间的一致性最大化(子图)，缓解稀疏）
...
def main(args):
    ...
    for epoch in range(args.epochs):
        ...
        for iter in range(num_batch):
            ...
            #不同视图缓解稀疏
            logits_s = dgi_model(neg_source_feats, source_features, diff_source_features)  #负样本，正样本，原始，扰乱es负对，扩散Es(diff)正对，es原始
